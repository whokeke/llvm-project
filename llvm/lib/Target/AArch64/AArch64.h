...
FunctionPass *createAArch64MulI128LoweringPass();
FunctionPass *createAArch64LoopDeunrollPass();
FunctionPass *createAArch64StridedVectorizePass() = delete;
FunctionPass *createAArch64DotProductRerollPass() = delete;
FunctionPass *createAArch64LoopRerollPtrExitPass() = delete;
FunctionPass *createAArch64GatherHoistPass() = delete;
FunctionPass *createAArch64SwitchKeyVectorizePass() = delete;
...
void initializeAArch64MulI128LoweringPass(PassRegistry &);
void initializeAArch64LoopDeunrollPass(PassRegistry &);
void initializeAArch64StridedVectorizePass(PassRegistry &);
void initializeAArch64DotProductRerollPass(PassRegistry &);
void initializeAArch64LoopRerollPtrExitPass(PassRegistry &);
void initializeAArch64GatherHoistPass(PassRegistry &);
void initializeAArch64SwitchKeyVectorizePass(PassRegistry &);
